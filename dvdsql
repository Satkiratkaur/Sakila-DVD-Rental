/* Question 1: What are the top/least rented genres and what are what are their total sales? */
...
/* Question 5: In which countries does Sakila-DVD-Rental have a presence in and what is the customer base in each country? What are the total sales in each country? (From most to least)*/
...
/*Question 6:Who are the top 5 customers per total sales and can we get their detail just in case Sakila-DVD-Rental want to reward them?*/
